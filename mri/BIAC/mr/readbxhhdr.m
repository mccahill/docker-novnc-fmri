...
% CVSId = '$Id: readbxhhdr.m,v 1.22 2011/02/24 17:07:13 gadde Exp $';
% CVSRevision = '$Revision: 1.22 $';
% CVSDate = '$Date: 2011/02/24 17:07:13 $';
...
try
  ...
  hdr=readxml(localloc,nsdecls,...
    ...
    '/bxh:bxh/bxh:datarec/@type','/bxh:bxh/bxh:datarec/@subtype',...
    '/bxh:bxh/bxh:datarec/bxh:dimension/@type','/bxh:bxh/@version',...
    '/bxh:bxh/bxh:datarec/bxh:filename',...
    ...
    '/xcede:serieslevel/xcede:datarec/xcede:filename');
catch
  if dellocalloc
...
%
% $Log: readbxhhdr.m,v $
% Revision 1.22  2011/02/24 17:07:13  gadde
% Fix reading of pseudo-numeric filenames
%
% Revision 1.21  2011/02/15 15:47:35  petty
% *** empty log message ***
%
